...
class NumberGenerator:
    def __init__(self, config_file_path:Path):
        config = json.loads(jsonnet.evaluate_file(str(config_file_path.expanduser())))
        ...
        assert self.output_dir_path.is_dir(), "Selected path is not directory..."
