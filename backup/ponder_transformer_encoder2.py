...
class PonderTransformerEncoder(nn.Module):
    def __init__(
        ...
        self.transformer_encoder_layer = nn.TransformerEncoderLayer(d_model=emb_dim,nhead=10,batch_first=True)
...
def main():
    vocab_size = 500
    model = PonderTransformerEncoder(vocab_size=vocab_size)
